...
export default function EditScheduleScreen({
  ...
  const {
    timetable,
    updateSchedule: updateScheduleContext,
    deleteSchedule,
  } = useTimetable();
  ...
  useEffect(() => {
    ...
    setAbbreviation(schedule.abbreviation || "");
  ...
  function validate() {
    ...
    const scheduleIndex: number = route.params.scheduleIndex;
    if (
      timetable?.schedules
  ...
  function updateSchedule() {
    ...
    const scheduleIndex: number = route.params.scheduleIndex;
    updateScheduleContext(scheduleIndex, newSchedule);
    navigation.goBack();
  }
